...
import {Variable, Constant} from '../reducers/index.js';
...
export default class ExpressionComponent extends React.Component{
  ...
  render() {
    this.variable = (<VariableComponent variable={this.props.expression.variable} objectschema={this.schema} onPropertyChange={this.propertyChanged.bind(this)}/>);
    this.constant = (
      <span>
