...
import {SimpleCondition, Condition} from '../reducers/grammar.js';
    ...
    prerender() {
        ...
        if (condition && condition.conditions && condition.conditions.length > 0) {
            this.subConditions = this.state.anyallcondition.conditions.map((condition, i) => {
                return (
                    <li key={i} className="treeChild">
                        <div className="treeChildDiv">
                            <div className="row">
                                <div className="col-md-11">
                                    <ConditionComponent key={i} id={i} schema={this.props.schema} condition={condition} PropertyChange={this.propertyChanged.bind(this)}/>
                                </div>
